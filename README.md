...
1\. When creating a new repository, use the [import functionality](https://bitbucket.org/repo/import) pointing to this template URL.

2\. Search for `TODO` keywords within the new repository for further instructions on what needs to be adjusted.
